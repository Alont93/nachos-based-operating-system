...
public class KThread {
    ...
    private boolean isBeingJoined;
    private KThread parentThread;
	...
	public static void finish() {
		...
		if (currentThread.isBeingJoined) {
		    currentThread.parentThread.ready();
		    currentThread.parentThread = null;
		    currentThread.isBeingJoined = false;
        }
	...
	public void join() {
        ...
        Lib.assertTrue(this != currentThread);
        Lib.assertTrue(!this.isBeingJoined);

        Machine.interrupt().disable();

        if (this.status != statusFinished) {
			this.isBeingJoined = true;
			this.parentThread = KThread.currentThread();
